        ...
        <div class="rounded-b-md py-1 -mt-px bg-white border border-gray-300">
          ...
          <div class="owl:border-t">
            <dd v-for="result in searchResults" :key="result.id" class="block border-gray-100">
              <g-link :to="`/shops?q=${result.center.join(',')}`" class="owl:ml-2 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 flex block px-3 py-2 text-gray-700 transition duration-150 ease-in-out">
